...
class MatchesController extends Controller
{
    ...
    public function matchDetails(Request $request, $id){
        ...
        $details=Customer::with(['gallery', 'Height', 'Ethnicity', 'Education', 'Job', 'Work', 'Religion'])->select('gender', 'dob', 'email', 'about_me', 'height_id', 'ethicity_id', 'education_id', 'occupation_id', 'job_id', 'religion_id', 'drinking', 'smoking', 'marijuana', 'drugs')
            ->findOrFail($id);
