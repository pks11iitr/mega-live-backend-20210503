            ...
            if($date <= $c->last_active){
                ...
                if(!$likes){
                    ...
                    foreach($ausers as $a){
                        ...
                        $c->notify(new FCMNotification($a->name.' likes your profile', $a->name.' likes your profile', ['type'=>'automatic-like', 'name'=>$a->name, 'image'=>$a->image, 'user_id'=>$a->id.''], 'profile_screen'));
                    }
