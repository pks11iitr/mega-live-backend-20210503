                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="address" class="form-control" id="exampleInputEmail1" placeholder="Enter Address" value="{{$customers->gender}}">
                      </div>
                    </div>
{{--                    <div class="col-md-6">--}}
{{--                      <div class="form-group">--}}
...
{{--                        </div>--}}
{{--                      </div>--}}
{{--                      <img src="{{$customers->image}}" height="100" width="200">--}}
{{--                    </div>--}}
                  </div>
                </div>
                <!-- /.card-body -->
